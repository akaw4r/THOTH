...
/**
 * First access: MFA enrollment screen. With MFA_REQUIRED=true the backend
 * blocks all routes (403 mfa_enrollment_required) until the user registers
 * TOTP or a passkey. With MFA_REQUIRED=false (default) the user may skip and
 * enroll later in Account settings.
 */
export function MfaSetupPage() {
  const { user, mfaRequired, refresh, logout } = useAuth();
